...
class Reserva:
    def __init__(self, cliente, habitaciones, fecha_inicio, num_noches):
        ...
        # Contar el número de habitaciones y personas
        ...
        # Marcar las habitaciones como no disponibles
...
def parser(documento):
    ...
    with open(documento, 'r', encoding='utf-8') as file:
        for line in file:
            ...
            if "Nombre del cliente" in line:
                # La siguiente línea no vacía será el nombre del cliente
    ...
    # Crear la reserva si tenemos todos los datos necesarios
...
def generar_reporte(reserva, archivo_salida="output.txt"):
    """Genera un archivo de salida con el formato especificado"""
    
    # Contamos las habitaciones por tipo
